...
_fire_time = 0.2;				// 0 - Infinite (Fire Time is both fire delay + fire rate.)
_fire_accumulator = 0;

_projectile_count = 100;				// 1 - Infinite
_projectile_object = Bullet;
_projectiles = [_projectile_count];
_projectile_speed = 1;					// 0 - 1
_projectile_speed_min = 1;				// 0 - Infinite
_projectile_speed_max = 5;				// 0 - Infinite
...
_kick = 0;
_kick_force = 0;	// -Infinite - Infinite
_kick_angle = 0;
