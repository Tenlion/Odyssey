...
_sprMagnet_x = x + lengthdir_x(_track_radius, _cannon_to_attachment_angle);
_sprMagnet_y = y + lengthdir_y(_track_radius, _cannon_to_attachment_angle);

_attachment.x = x + lengthdir_x(attachment_distance_from_track, _cannon_to_attachment_angle);
_attachment.y = y + lengthdir_y(attachment_distance_from_track, _cannon_to_attachment_angle);

_attachment._direction = _cannon_to_attachment_angle;
...
for (var attach = 0; attach < _number_of_attachments; attach++) {
	...
	if (_attachments[attach]._active != true) {
		...
		_attachments[attach].x = x + lengthdir_x(attachment_distance_from_track, _attachments[attach]._direction);
		_attachments[attach].y = y + lengthdir_y(attachment_distance_from_track, _attachments[attach]._direction);
	}
}
