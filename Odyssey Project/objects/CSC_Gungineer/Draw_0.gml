...
draw_sprite_ext(chassis_sprite, 0, cannon_x, cannon_y, chassis_sprite_width_scale, chassis_sprite_height_scale, chassis_sprite_rotation, chassis_sprite_color, 1);
